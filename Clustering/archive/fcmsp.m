function [center, U, obj_fcn] = fcmsp(data, neighbors,cluster_n, options)
% ATTENTION:
% =========================================================================
% This is the legacy version of the robust fuzzy c-means
% function.
% Please use rfcm.m if you want to write new code.
% Problem of this code (together with stepfcmsp.m):
...
% Main loop
for i = 1:max_iter,
	[U, center, obj_fcn(i)] = stepfcmsp(data, neighbors, U, cluster_n, expo);
	if display, 
...
%         if obj_fcn(i) - obj_fcn(i-1) < -10, break; end,
	end
end
