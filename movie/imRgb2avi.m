function varargout = imRgb2avi(ext, imDir, scale, frameRate, fileName)
% converts rgb image sequenses to avi video
%
%   SYNTAX:
%   imRgb2avi(ext, imDir, scale, frameRate, fileName)
%   mov = imRgb2avi(ext, imDir, scale, frameRate, fileName)
%
%   INPUT:
...
% 5. color image is used as input
%=============================================================
%
...
D = zeros(size(I1, 1), size(I1, 2), 3, numIms);
...
movie2avi(mv, fileName, 'fps', frameRate);
